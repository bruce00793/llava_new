#!/bin/bash
# ============================================================
# Q-Former V1 对比实验 — 15% 数据子集（与 V2 用完全相同的数据）
# 6×4090 分布式训练
# ============================================================
#
# 目的：与 train_v2_15pct.sh 做公平对比
# 唯一区别：--qformer-version v1（默认，不需要写）
#
# 子集：data/subset_15pct_scenes.txt（105 个场景，seed=42）
# Q-Former：V1（原版 BLIP-2 风格）
# 学习率：与 V2 完全一致
#
# 用法: bash scripts/train_v1_15pct.sh
# ============================================================
...
OUTPUT_DIR="./outputs/v1_15pct_$(date +%Y%m%d_%H%M%S)"
...
echo "================================================================="
echo "Q-Former V1 对比实验 — 15% 数据子集 (105 scenes)"
echo "================================================================="
echo "Q-Former:    V1（原版）"
